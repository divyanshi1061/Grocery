...
function HeroSection() {
    ...
    const slides = [
        {
            id: 1,
            icon: <Leaf className="w-20 h-20 sm:w-28 sm:h-28 text-orange-400 drop-shadow-lg" />,
            title: "Fresh Organic Groceries 🥬",
            subtitle: "Farm-fresh fruits, vegetables, and daily essentials delivered to you.",
            btnText: "Shop Now",
            bg: "https://plus.unsplash.com/premium_photo-1683121938935-118d0a16a469?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
...

        {
            ...
            btnText: "Order Now",
            bg: "https://images.unsplash.com/photo-1675942206949-0ca35f686de7?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
        },

        {
            ...
            subtitle: "Order groceries easily from your phone in just a few taps.",
            btnText: "Get Started",
            bg: "https://plus.unsplash.com/premium_photo-1664201890375-f8fa405cdb7d?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
        }
            ...
            <div className='absolute inset-0 flex items-center justify-center text-center text-white px-6'>
                ...
                >
                    ...
                    <motion.button
                        ...
                        className='mt-4 bg-white text-orange-700 hover:bg-orange-100 px-8 py-3 rounded-full font-semibold shadow-lg transition-all duration-300 flex items-center gap-2'><ShoppingBasket className='w-5 h-5' />
                        {slides[current].btnText}</motion.button>
                </motion.div>
            </div>
