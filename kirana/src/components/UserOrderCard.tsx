...
function UserOrderCard({ order }: { order: IOrder }) {
  ...
  return (
    ...
    >
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-3 border-b border-gray-100 px-5 py-4 bg-gradient-to-r from-orange-50 to-white">
      ...
      <div className="p-5 space-y-4">
        ...
        {deliveryBoy && <> <div className='mt-4 bg-blue-50 border border-blue-200 rounded-xl p-4 flex items-center justify-between'>
          ...
          <a href={`tel:${deliveryBoy.mobile}`} className="bg-blue-600 text-white text-xs px-3 py-1.5 rounded-lg hover:bg-blue-700 transition">
            Call
          </a>
        </div>
         <button className="w-full flex gap-2 justify-center items-center bg-orange-600 text-white font-semibold px-4 py-2 bg-orange-600 rounded-xl shadow hover:bg-orange-700 transition"
        ...
        <div className="border-t border-gray-100 pt-4 flex justify-between items-center text-sm font-semibold text-gray-800">
          <div className="flex items-center gap-2 text-gray-700 text-sm">
            ...
            <span>
              Delivery: <span className="text-orange-700 font-bold capitalize">{status}</span>
            </span>
          </div>
          <div>
